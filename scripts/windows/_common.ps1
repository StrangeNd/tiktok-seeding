<<<<<<< C:/Users/Stephen Strange/CascadeProjects/tiktok-seeding/scripts/windows/_common.ps1
...
function Write-Warn2{ param([string]$Msg) Write-Host "    WARN $Msg" -ForegroundColor Yellow }
function Write-Fail { param([string]$Msg) Write-Host "    FAIL $Msg" -ForegroundColor Red }
>>>>>>> C:/Users/Stephen Strange/.windsurf/worktrees/tiktok-seeding/tiktok-seeding-3c3dd21a/scripts/windows/_common.ps1
